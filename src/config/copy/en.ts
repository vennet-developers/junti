...
export const en: Copy = {
  ...
  eventCreated: {
    ...
    participantLinkHelp: "This is the one you share. It lets people RSVP and see who owes what.",
  ...
  event: {
    closedBadge: "Closed",
    closedNotice: "This event is closed. Nobody can RSVP or change their answer.",
