 ...
 *
 * The list is the server's. Nothing is hidden optimistically: the action
 * returns how many rows it actually decided — which is not always how many were
 * ticked, since a queue open in another tab may have resolved some already —
 * and that number is what gets reported before the page re-renders from the
 * database.
 */
