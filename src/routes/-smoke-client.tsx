...
import { EventList, type EventListItem } from "./my-events/-event-list";
  ...
  return (
    <Container size="1">
      <Stack gap="lg" py="6" px="4">
        ...
        {/* Skeleton — the loading placeholder the pending states use. */}
        <Stack gap="2">
        ...
        */}
        ...
        {/*
          Exercised here rather than behind a session, like everything else on
          this page: the point is the editing, not the storing. The form is
          the PORTED one — the Next copy's actions would ride into this
          bundle and trip the tripwire.
        */}
        <Stack gap="3">
